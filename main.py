'''student database management system project in python using tkinter and mysql'''
...
class Management:
    ...
    def AddStudent(self):
        ...
        self.year = Label(self.frame_1, text="Passing Year", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=170)
        ...
        self.contact = Label(self.frame_1, text="Mobile Number", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=310)
    ...
    def GetContact_View(self):
        ...
        self.getInfo = Label(self.frame_1, text="Enter Mobile Number", font=(self.font_2, 18, "bold"), bg=self.color_1).place(x=140,y=70)
    ...
    def CheckContact_View(self):
        if self.getInfo_entry.get() == "":
            messagebox.showerror("Error!", "Please enter your Mobile number",parent=self.window)
        else:
            try:
                ...
                if row == None:
                    messagebox.showerror("Error!","Data of the Student Dosen't Exist",parent=self.window)
                else:
    ...
    def CheckContact_Update(self):
        if self.getInfo_entry.get() == "":
            ...
            try:
                ...
                if row == None:
                    messagebox.showerror("Error!","Mobile number doesn't exists",parent=self.window)
                else:
    ...
    def GetUpdateDetails(self, row):
        ...
        contact = Label(self.frame_1, text="Mobile Number", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=310)
    ...
    def ShowDetails(self, row):
        ...
        year = Label(self.frame_1, text="Passing Year", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=170)
    ...
    def UpdateDetails(self, row):
        if self.name_entry.get() == "" or self.surname_entry.get() == "" or self.course_entry.get() == "" or self.subject_entry.get() == "" or self.year_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self.birth_entry.get() == "" or self.email_entry.get() == "":
            ...
            try:
                ...
                if row==None:
                    messagebox.showerror("Error!","The Mobile number doesn't exists",parent=self.window)
                else:
    ...
    def Submit(self):
        if self.name_entry.get() == "" or self.surname_entry.get() == "" or self.course_entry.get() == "" or self.subject_entry.get() == "" or self.year_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self.birth_entry.get() == "" or self.contact_entry.get() == "" or self.email_entry.get() == "":
            ...
            try:
                ...
                if row!=None:
                    messagebox.showerror("Error!","The Mobile number is already exists, please try again with another number",parent=self.window)
                else:
